            ...
            <DialogPanel
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  <CustomInput class="mb-2" v-model="manufacturer.name" label="Manufacturer Title"/>
                  <CustomInput type="textarea" class="mb-2" v-model="manufacturer.description" label="Description"/>
                </div>
...
const manufacturer = ref({
  ...
  description: props.manufacturer.description,
})
...
function onSubmit() {
  loading.value = true
    store.dispatch('createManufacturer', manufacturer.value)
      .then(response => {
        loading.value = false;
