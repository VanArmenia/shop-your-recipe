            ...
            <DialogPanel
              ...
              <header class="py-3 px-4 flex justify-between items-center">
                <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900">
                  {{ recipe.id ? `Update Recipe: "${props.recipe.name}"` : 'Create a new Recipe' }}
                </DialogTitle>
                <button
                  @click="closeModal()"
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  <CustomInput class="mb-2" v-model="recipe.name" label="Recipe Title"/>
                  <CustomInput type="file" class="mb-2" label="Recipe Image" @change="file => recipe.image = file"/>
                  <CustomInput type="textarea" class="mb-2" v-model="recipe.description" label="Description"/>
                </div>
